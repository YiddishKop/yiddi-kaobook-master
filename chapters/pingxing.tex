...
\cleardoublepage
\marginnote{
【提示】\\过圆心的直线总是平分圆的周长和面积, 实际上任何一个中心对称图形都有这个性质：过对称中心的
直线，平分周长和面积。
}
\begin{example}
...
\begin{example}
    $$
    \begin{aligned}
        &(1)\text{如图 }1,\text{点 }A,B,C,D\text{ 均在格点上},\text{在 }AC\text{ 上找点 }E,\text{使 }DE//AB;\\
        &(2)\text{如图 }2,\text{点 }A,B,C\text{ 均在格点上},\text{作平行四边形 }ABCD,\text{再在 }CD\text{ 上作点 }N,\text{使 }CN\\&=AM;\\
        &(3)\text{如图 }3,\text{过点 }C\text{ 作}CD\perp AB;\\
        &(4)\text{如图 }4,\text{作点 }F,\text{使得 }EF=\sqrt{10}(\text{每个小正方形的边长为 }1).
    \end{aligned}
    $$
...
\begin{example}有下列说法：①平行四边形具有四边形的所有性质；
