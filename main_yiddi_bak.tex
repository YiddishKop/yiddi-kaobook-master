...
\usepackage{myfonts} % 添加中文支持
%\setCJKmainfont{Source Han Serif CN} % 替换为中文字体
...
\subject{使用这个模板 哈喽 kaobboollk，Use this document as a template}
...
\publishers{An 奥色黑幕出版社 Publisher}
